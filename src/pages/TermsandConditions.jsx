    ...
    <>
      ...
      <MainContainer themeCurrent={themeCurrent}>
        ...
        <p>
          ...
          use of The Social Scoop's Website, located at
          thesocialscoop.netlify.app.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use The Social Scoop if you do not
        ...
        <SubHeadings>
          ...
          <p>
            We employ the use of cookies. By accessing The Social Scoop, you
            agreed to use cookies in agreement with the The Social Scoop's
            Privacy Policy.{" "}
          </p>
        ...
        <SubHeadings>
          ...
          <p>
            Unless otherwise stated, The Social Scoop and/or its licensors own
            the intellectual property rights for all material on The Social
            Scoop. All intellectual property rights are reserved. You may access
            this from The Social Scoop for your own personal use subjected to
          ...
          <p>This Agreement shall begin on the date May 24th, 2022.</p>

          <p>
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            The Social Scoop does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of The Social Scoop,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their
            views and opinions. To the extent permitted by applicable laws, The
            Social Scoop shall not be liable for the Comments or for any
          ...
          <p>
            The Social Scoop reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant The Social Scoop a non-exclusive license to use,
        ...
        <SubHeadings>
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of The Social
            Scoop; and (d) the link is in the context of general resource
            information.
          </p>
          ...
          <p>
            ...
            sending an e-mail to The Social Scoop. Please include your name,
          ...
          <p>
            No use of The Social Scoop's logo or other artwork will be allowed
